...
REM		Date creation/modification : 	10/11/2023
...
REM     Affichage du nom du système d'exploitation Windows :              	Microsoft Windows 11 Famille - exemple
REM 	Affichage de la version du système Windows :              			10.0.22621 - exemple
...
REM 		-v                			Set output functions declarations to .def  (same root name like source file)
...
wcc386 -q -bd -d0 -v -dNDEBUG -dBUILD_DLL -d_WIN32 src\dll_core.c -i=C:\WATCOM\h\nt -i=C:\WATCOM\h -fo=dll_core.obj
echo. *****************           Edition des liens .ie. linkage de la DLL.        ***************
REM     Options used by linker of Open Watcom 
...
REM 			implib=xxxxxx				Instruct linker to generate lib file in parallel of DLL (ATTENTION : don't work !!!) 
REM 			quiet						Set to quiet mode
REM 				don't use impfile=xxxxxx				Instruct linker to generate def file. But then library file is not created if option impfile is present !!!!
...
echo. ************     				Liste du contenu du fichier dll_core.def      						*************
type dll_core.def
...
wcc386 -q -bc -bt=nt -d0 -dNDEBUG -d_WIN32 src\testdll_implicit.c -i=C:\WATCOM\h\nt -i=C:\WATCOM\h -fo=testdll_implicit.obj
REM 	Options used by linker of Open Watcom compiler
REM 		-subsystem console 			Define subsystem to console, because generation of console application needed
...
wcc386 -q -bc -bt=nt -d0 -dNDEBUG -d_WIN32 src\testdll_explicit.c -i=C:\WATCOM\h\nt -i=C:\WATCOM\h -fo=testdll_explicit.obj
...
echo. ************     				Liste du contenu du fichier dll_core.def      							*************
type dll_core.def
REM 	Not mandatory here, wlink can generate lib file with option implib=dll_core.lib, but without another option impfile=dll_core64.def on same line ???? 
...
echo. ************     Generation et lancement du deuxieme programme de test de la DLL en mode explicite.     ************
wcc386 -q -bc -bt=nt -d0 -dNDEBUG -d_WIN32 -d__OW64__ src\testdll_explicit.c -i=C:\WATCOM\h\nt -i=C:\WATCOM\h -fo=testdll_explicit64.obj
...
REM 		-ixxxxxx					Define search path to include file
REM 		-fo=xxxxx 					Define output file generated by Open Watcom compiler, here obj file
wcl386 -q -bd -l=nt_dll -d0 -v -dNDEBUG -dBUILD_DLL -d_WIN32 -i=C:\WATCOM\h\nt -i=C:\WATCOM\h -fe=dll_core64.dll -"LIBP C:\WATCOM\lib386\nt;C:\WATCOM\lib386" -"EXPORT=src\dll_core.lbc" -"option implib=dll_core64.lib" -"option quiet" src\dll_core.c 
REM echo. ************     				Liste du contenu du fichier dll_core64.def      							*************
REM type dll_core64.def
REM 	Not mandatory here, wlink can generate lib file with option implib=dll_core.lib, but without another option impfile=dll_core64.def on same line ???? 
REM wlib -q -n dll_core64.lib +dll_core64.dll
REM 	Options used by tool "wdump" of Open Watcom compiler
REM 		-i				Show list of exported symbols from a library/exe/obj/dll
...
echo. ************     Generation et lancement du deuxieme programme de test de la DLL en mode explicite.     ************
wcl386 -q -l=nt -d0 -dNDEBUG -d_WIN32  -d__OW64__ src\testdll_explicit.c -i=C:\WATCOM\h\nt -i=C:\WATCOM\h -fe=testdll_explicit64.exe -"LIBP C:\WATCOM\lib386\nt;C:\WATCOM\lib386" -"option quiet"
REM 	Run test program of DLL with explicit load
